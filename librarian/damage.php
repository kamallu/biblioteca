			   ...
			   <div class="alert alert-info">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										...
										<li class="active"><a href="damage.php">LIBROS MALOGRADOS</a></li>
										<li><a href="sub_rep.php">TEMA PARA REEMPLAZO</a></li>
									</ul>
						<!--  -->
						<center class="title">
						<h1>LIBROS MALOGRADOS</h1>
						</center>
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'Malogrado'")or die(mysql_error());
