      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li  class="active"><a href="users.php"><i class="icon-user icon-large"></i>&nbsp;USUARIOS</a></li>
					<?php 
					include('dropdown.php');
					?>
					<li><a href="books.php"><i class="icon-book icon-large"></i>&nbsp;LIBROS</a></li>
					<li><a href="member.php"><i class="icon-group icon-large"></i>&nbsp;MIEMBROS</a></li>
					...
					<li><a href="logout.php" ><i class="icon-signout icon-large"></i>&nbsp;SALIR</a></li>
					 ...
					 <div class="pull-right">
						<div class="admin">NIENVENIDO: BILBIOTECARIO</div>
                     </div>
                    </div>
                </div>
            </div>
