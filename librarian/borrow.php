		...
		<div class="margin-top">
			<div class="row">	
								<div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;LIBROS PRESTADOS</strong>
                                </div>
...
<div class="span3">
				...
				<label class="control-label" for="inputEmail">El Nombre del Prestatario</label>
				<div class="controls">
				...
				<div class="control-group"> 
					<label class="control-label" for="inputEmail">FECHA DE VENCIMIENTO</label>
					<div class="controls">
				...
				<div class="span8">
						<div class="alert alert-success"><strong>SELECCIONE LIBRO</strong></div>
