			   ...
			   <div class="alert alert-info">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										<li><a href="books.php">TITULO</a></li>
										...
										<li class="active"><a href="sub_rep.php">TEMA PARA REEMPLAZO</a></li>
									</ul>
						<!--  -->
						<center class="title">
						<h1>LIBROS PARA REEMPLAZOS</h1>
						</center>
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'Tema de reemplazo'")or die(mysql_error());
