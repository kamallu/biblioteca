		...
		<div class="margin-top">
			...
			<div class="span2">			     
										<ul class="nav nav-tabs nav-stacked">
											<li>
											<a href="#add_user" data-toggle="modal" ><i class="icon-plus icon-large"></i>&nbsp;<strong>ADD USUARIO</strong></a>
											</li>
										</ul>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php $user_query=mysql_query("select * from users")or die(mysql_error());
                                    ...
                                    <td width="100">
                                        <a rel="tooltip"  title="Eliminar" id="<?php echo $id; ?>"  href="#delete_user<?php echo $id; ?>" data-toggle="modal"  class="btn btn-danger"><i class="icon-trash icon-large"></i></a>
